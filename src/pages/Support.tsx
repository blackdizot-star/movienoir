...
const FAQS = [
  { q: "Is MovieNoir free?", a: "Yes. MovieNoir is free to use and supported by ads." },
  ...
  { q: "Where do I report a problem?", a: "Send an email to info.bingbloom@gmail.com or use the form on /contact." },
];

const Support = () => (
  <AppLayout>
    <SEO title="Help Center – MovieNoir" description="Get help with MovieNoir — FAQs, support and contact information." />
    <div className="max-w-2xl mx-auto px-5 py-6 text-white">
      ...
      <Link to="/contact" className="mt-5 inline-block px-5 py-3 rounded-xl text-white font-semibold" style={{ background: "#FF2D8F" }}>
        Contact Support
      </Link>
    </div>
  </AppLayout>
