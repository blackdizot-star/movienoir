...
const DocumentaryPage = () => {
  ...
  return (
    <AppLayout>
      <SEO
        title="Documentaries – MovieNoir"
        description="Real stories, real people. Explore the world with trending and top-rated documentaries and docuseries streaming on MovieNoir."
      />
