...
const sections = [
  ...
  { heading: "How We Use Your Information", bullets: [
    "Provide and improve the MovieNoir service",
...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy" description="How MovieNoir collects, uses and protects your personal information." updated="June 2026" sections={sections} />;
}
