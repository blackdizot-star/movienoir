      ...
      <DialogContent className="max-w-sm bg-[#0f0f10] border-white/10 text-white">
        <DialogHeader>
          <div className="flex items-center gap-2 mb-1">
            <ShieldAlert className="w-4 h-4 text-[#FF2D8F]" />
            <DialogTitle className="text-sm font-bold">You're leaving MovieNoir</DialogTitle>
          </div>
          <DialogDescription className="text-[11px] text-white/65 leading-relaxed">
            ...
            download page inside an in-app browser. MovieNoir doesn't host or control the file.
          </DialogDescription>
        </DialogHeader>
